...
// dash models
const dash_bank_model_1 = __importDefault(require("../../modules/dash/dash-bank/db/models/dash-bank.model"));
const dash_city_model_1 = __importDefault(require("../../modules/dash/dash-city/db/models/dash-city.model"));
const dash_customer_model_1 = __importDefault(require("../../modules/dash/dash-customer/db/models/dash-customer.model"));
const dash_customer_has_bank_model_1 = __importDefault(require("../../modules/dash/dash-customer-has-bank/db/models/dash-customer-has-bank.model"));
const dash_customer_user_model_1 = __importDefault(require("../../modules/dash/dash-customer-user/db/models/dash-customer-user.model"));
const dash_funcionario_model_1 = __importDefault(require("../../modules/dash/dash-funcionario/db/models/dash-funcionario.model"));
const dash_negotiation_model_1 = __importDefault(require("../../modules/dash/dash-negotiation/db/models/dash-negotiation.model"));
const dash_rol_model_1 = __importDefault(require("../../modules/dash/dash-rol/db/models/dash-rol.model"));
//extrajudicial models
const extrajudicial_client_model_1 = __importDefault(require("../../modules/extrajudicial/extrajudicial-client/db/models/extrajudicial-client.model"));
//judicial models
const judicial_bin_procedural_stage_model_1 = __importDefault(require("../../modules/judicial/judicial-bin-procedural-stage/db/models/judicial-bin-procedural-stage.model"));
const judicial_bin_type_binnacle_model_1 = __importDefault(require("../../modules/judicial/judicial-bin-type-binnacle/db/models/judicial-bin-type-binnacle.model"));
const judicial_binnacle_model_1 = __importDefault(require("../../modules/judicial/judicial-binnacle/db/models/judicial-binnacle.model"));
const judicial_case_file_model_1 = __importDefault(require("../../modules/judicial/judicial-case-file/db/models/judicial-case-file.model"));
const judicial_court_model_1 = __importDefault(require("../../modules/judicial/judicial-court/db/models/judicial-court.model"));
const judicial_procedural_way_model_1 = __importDefault(require("../../modules/judicial/judicial-procedural-way/db/models/judicial-procedural-way.model"));
const judicial_process_reason_model_1 = __importDefault(require("../../modules/judicial/judicial-process-reason/db/models/judicial-process-reason.model"));
const judicial_sede_model_1 = __importDefault(require("../../modules/judicial/judicial-sede/db/models/judicial-sede.model"));
const judicial_subject_model_1 = __importDefault(require("../../modules/judicial/judicial-subject/db/models/judicial-subject.model"));
// dash models
