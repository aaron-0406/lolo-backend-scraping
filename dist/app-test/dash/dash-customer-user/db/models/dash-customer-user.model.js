...
const dash_rol_model_1 = __importDefault(require("../../../dash-rol/db/models/dash-rol.model"));
...
const CustomerUserSchema = {
    ...
    roleId: {
        ...
        type: sequelize_1.DataTypes.INTEGER,
        references: {
            model: dash_rol_model_1.default.ROLE_TABLE,
            key: "id_role",
        },
        onUpdate: "CASCADE",
        onDelete: "NO ACTION",
    ...
    customerId: {
        ...
        type: sequelize_1.DataTypes.INTEGER,
        references: {
            model: dash_customer_model_1.default.CUSTOMER_TABLE,
            key: "id_customer",
        },
        onUpdate: "CASCADE",
        onDelete: "NO ACTION",
