...
class GoalService {
    ...
    finGlobalGoal(customerId_1) {
        return __awaiter(this, arguments, void 0, function* (customerId, fecha = new Date()) {
    ...
    findGoalUserByCustomerId(customerUserId_1) {
        return __awaiter(this, arguments, void 0, function* (customerUserId, fecha = new Date()) {
