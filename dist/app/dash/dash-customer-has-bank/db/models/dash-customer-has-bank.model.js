...
const dash_customer_model_1 = __importDefault(require("../../../dash-customer/db/models/dash-customer.model"));
const dash_bank_model_1 = __importDefault(require("../../../dash-bank/db/models/dash-bank.model"));
const { BANK_TABLE } = dash_bank_model_1.default;
const { CUSTOMER_TABLE } = dash_customer_model_1.default;
