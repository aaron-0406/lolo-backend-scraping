...
import { JudicialCaseFileType } from "../../modules/types/judicial-case-file.type";

import clientModel from "../../../../extrajudicial/extrajudicial-client/db/models/extrajudicial-client.model";
import customerHasBankModel from "../../../../dash/dash-customer-has-bank/db/models/dash-customer-has-bank.model";
import cityModel from "../../../../dash/dash-city/db/models/dash-city.model";
import judicialCourtModel from "../../../judicial-court/db/models/judicial-court.model";
import judicialSedeModel from "../../../judicial-sede/db/models/judicial-sede.model";
import judicialProceduralWayModel from "../../../judicial-procedural-way/db/models/judicial-procedural-way.model";
import judicialSubjectModel from "../../../judicial-subject/db/models/judicial-subject.model";
import judicialProcessReasonModel from "../../../judicial-process-reason/db/models/judicial-process-reason.model";
import customerUserModel from "../../../../dash/dash-customer-user/db/models/dash-customer-user.model";
import bankModel from "../../../../dash/dash-bank/db/models/dash-bank.model";
